...
class DadosBancarios(models.Model):
    empresa = models.OneToOneField(Empresa, on_delete=models.CASCADE, null=False, blank=False, related_name='rel_dados_bancarios')
    TIPO_TED = 'TD'
    TIPO_PIX = 'PX'
    TIPO_PAGAMENTO = [
        (TIPO_TED, 'TED'),
    ...
    def clean(self):
        if not self.empresa:
            raise ValidationError("Um DadosBancarios deve estar associado a uma Empresa.")
